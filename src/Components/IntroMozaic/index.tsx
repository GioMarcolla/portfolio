        ...
        >
            <div className="flex flex-row flex-1 gap-2 max-h-[50%]">
                ...
                <div className="relative flex-20">
                    <div className="bg-primary pr-1 pb-1 rounded-2xl rounded-br-[calc(1rem+4px)] w-full h-full overflow-hidden container">
                        <img
                ...
                <div className="flex flex-col flex-10 gap-2">
                    <div className="flex-2 bg-secondary pr-1 pb-1 rounded-2xl rounded-br-[calc(1rem+4px)] w-full h-full overflow-hidden container">
                        <img
            ...
            <div className="flex flex-row flex-1 gap-2 max-h-[50%]">
                ...
                <div className="flex-1">
                    <div className="flex-2 bg-accent pr-1 pb-1 rounded-2xl rounded-br-[calc(1rem+4px)] w-full h-full overflow-hidden container">
                        <img
